...
def activate_therapy_mode():
    ...
    while True:
        ...
        ai_response = get_therapy_response(user_input) # Use the original user_input for context
        print(f"Therapist: {ai_response}") # Optional: print response to console
        audio.speak(ai_response)

# Add the main execution block
if __name__ == "__main__":
    try:
        activate_therapy_mode()
